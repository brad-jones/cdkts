...
func main() {
	...
	if err := execBinary(denoPath, append([]string{"run", "-qA", fmt.Sprintf("https://jsr.io/@brad-jones/cdkts/%s/cli/main.ts", cdkTsVersion)}, os.Args[1:]...)); err != nil {
